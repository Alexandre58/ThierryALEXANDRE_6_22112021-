...
module.exports = (req, res, next) => {
  if (validPasswordschema.validate(req.body.password)) {
    next();
      ...
      return res
      .status(400)
      .json({error : "Le mot de passe n'est pas  fort " + validPasswordschema.validate('req.body.password', { list: true })})
  }
};
/*
console.log("****************************************");
console.log(validPasswordschema.validate('req.body.password', { list: true }));
console.log("****************************************");
*/